...
Структура основной части проекта: 
AntiPlagiarism/
├── AntiPlagiarism.ApiGateway/             # API Gateway сервис
│   ├── Application/                       # Бизнес-логика шлюза
│   │   ├── Interfaces/
│   │   └── Services/
│   ├── Presentation/                      # Контроллеры API
│   ├── Dockerfile
│   └── Program.cs
├── AntiPlagiarism.FileStoringService/     # Сервис хранения файлов
│   ├── Application/                       # Бизнес-логика
│   ├── Domain/                            # Доменные модели
│   ├── Infrastructure/                    # Реализация хранилища и репозитория
│   ├── Presentation/                      # Контроллеры API
│   ├── Dockerfile
│   └── Program.cs
├── AntiPlagiarism.FileAnalysisService/    # Сервис анализа файлов
│   ├── Application/                       # Бизнес-логика
│   ├── Domain/                            # Доменные модели
│   ├── Infrastructure/                    # Реализация репозиториев и хранилища
│   ├── Presentation/                      # Контроллеры API
│   ├── Dockerfile
│   └── Program.cs
├── AntiPlagiarism.Common/                 # Общая библиотека
